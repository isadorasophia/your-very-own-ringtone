...
namespace YourVeryOwnRingtone
{
    ...
    public sealed class YourVeryOwnRingtonePackage : AsyncPackage
    {
        ...
        /// </summary>
        public const string PackageGuidString = "fbb91e8e-d25b-49ec-b3dc-34678dd0b52a";

        [Import]
        private SoundManager _soundManager { get; set; } = null!;
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            {
                throw new InvalidOperationException("Unable to initialize sounds... Is MEF being weird?");
            }
